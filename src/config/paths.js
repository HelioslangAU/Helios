...
class PathsConfig {
  constructor() {
    ...
    this.FREQ_DICT_JA = 'freq-dict-ja/';
    ...
    // Frequency dictionary files (Chinese — BLCU corpus)
    ...
    // Frequency dictionary files (Japanese — BCCWJ-SUW corpus, 18 banks)
    this.FREQUENCY_FILES_JA = [
      'term_meta_bank_1.json',
      'term_meta_bank_2.json',
      'term_meta_bank_3.json',
      'term_meta_bank_4.json',
      ...
      'term_meta_bank_11.json',
      'term_meta_bank_12.json',
      'term_meta_bank_13.json',
      'term_meta_bank_14.json',
      'term_meta_bank_15.json',
      'term_meta_bank_16.json',
      'term_meta_bank_17.json',
      'term_meta_bank_18.json'
    ];
