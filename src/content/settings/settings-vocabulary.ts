...
export class HeliosSettingsVocabulary {
  ...
  async importKnownWords(): Promise<void> {
  ...
  async exportKnownWords(): Promise<void> {
    try {
  ...
  async backupAllData(): Promise<void> {
    try {
      ...
      await this.vocabManager!.loadKnownWords();
      const allKnownWords: Record<string, string[]> = this.vocabManager!.getAllKnownWordsAllLanguages();
  ...
  updateAnkiImportButtonState(): void {
    const importButton = document.getElementById("vocab-anki-import-known-words") as HTMLButtonElement | null;
  ...
  updateAnkiSyncButtonState(): void {
    const syncButton = document.getElementById("vocab-anki-sync-learning-words") as HTMLButtonElement | null;
