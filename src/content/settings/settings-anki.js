...
class HeliosSettingsAnki {
  ...
  getAvailableDataTypes() {
    ...
    if (language === 'zh') {
      ...
      return [
        { value: "", label: "Not mapped" },
        { value: "expression", label: "Expression (日本語)" },
        { value: "reading", label: "Reading (にほんご)" },
        { value: "meaning", label: "Meaning (Japanese language)" },
        { value: "sentence", label: "Sentence (日本語は難しい)" },
        { value: "source", label: "Source URL" },
        { value: "frequency", label: "Frequency Rank (BCCWJ)" },
        { value: "screenshot", label: "Screenshot (image)" },
        { value: "sentenceAudio", label: "Sentence Audio (audio file)" },
      ];
    } else {
