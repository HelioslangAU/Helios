...
export class PopupPositioner {
  static positionPopup(popup: HTMLElement, highlightManager: HighlightManager): boolean {
  ...
  static createPopupElement(fontSize: string | undefined = 'medium'): HTMLDivElement {
