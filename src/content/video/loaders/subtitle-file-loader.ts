 ...
 */
export class SubtitleFileLoader {
   ...
   */
  async _setupKeyboardShortcut(): Promise<void> {
   ...
   */
  _isDraggingFile(e: DragEvent): boolean {
   ...
   */
  async _handleFile(file: File): Promise<void> {
