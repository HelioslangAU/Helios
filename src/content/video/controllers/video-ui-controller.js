  ...
  async _findMatchingTrack(tracks, targetLanguage) {
    ...
    if (videoId) {
      try {
        ...
        if (perVideoPref) {
          ...
          if (preferredTrack) {
            console.log('[Helios Video] Using per-video preference:', preferredTrack.languageName);
    ...
    try {
      ...
      if (globalPref) {
        ...
        if (preferredTrack) {
          console.log('[Helios Video] Using global language preference:', preferredTrack.languageName);
          return preferredTrack;
        }
      }
    } catch (error) {
