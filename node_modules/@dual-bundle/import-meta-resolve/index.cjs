...
function emitLegacyIndexDeprecation(url, packageJsonUrl, base, main) {
  ...
  const packagePath = (0, import_node_url3.fileURLToPath)(new URL(".", packageJsonUrl));
...
function legacyMainResolve(packageJsonUrl, packageConfig, base) {
  ...
  throw new ERR_MODULE_NOT_FOUND(
    (0, import_node_url3.fileURLToPath)(new URL(".", packageJsonUrl)),
...
function importNotDefined(specifier, packageJsonUrl, base) {
  return new ERR_PACKAGE_IMPORT_NOT_DEFINED(
    specifier,
    packageJsonUrl && (0, import_node_url3.fileURLToPath)(new URL(".", packageJsonUrl)),
    (0, import_node_url3.fileURLToPath)(base)
  );
}
...
function defaultResolve(specifier, context = {}) {
  ...
  import_node_assert2.default.ok(parentURL !== void 0, "expected `parentURL` to be defined");
